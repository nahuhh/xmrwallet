...
import one.mayumi.xmrwallet.dialog.AboutFragment;
import one.mayumi.xmrwallet.dialog.CreditsFragment;
import one.mayumi.xmrwallet.dialog.PrivacyFragment;
import one.mayumi.xmrwallet.util.DayNightMode;
import one.mayumi.xmrwallet.util.LocaleHelper;
import one.mayumi.xmrwallet.util.NightmodeHelper;
