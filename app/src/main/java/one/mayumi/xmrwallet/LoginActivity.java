...
import one.mayumi.xmrwallet.data.DefaultNodes;
import one.mayumi.xmrwallet.data.Node;
import one.mayumi.xmrwallet.data.NodeInfo;
import one.mayumi.xmrwallet.dialog.HelpFragment;
import one.mayumi.xmrwallet.ledger.Ledger;
import one.mayumi.xmrwallet.ledger.LedgerProgressDialog;
...
import one.mayumi.xmrwallet.service.WalletService;
import one.mayumi.xmrwallet.util.Helper;
import one.mayumi.xmrwallet.util.KeyStoreHelper;
import one.mayumi.xmrwallet.util.LegacyStorageHelper;
import one.mayumi.xmrwallet.util.MoneroThreadPoolExecutor;
import one.mayumi.xmrwallet.util.NetCipherHelper;
import one.mayumi.xmrwallet.util.ThemeHelper;
import one.mayumi.xmrwallet.util.ZipBackup;
import one.mayumi.xmrwallet.util.ZipRestore;
...
public class LoginActivity extends BaseActivity
    ...
    private static final String ACTION_USB_PERMISSION = "one.m2049r.xmrwallet.USB_PERMISSION";
