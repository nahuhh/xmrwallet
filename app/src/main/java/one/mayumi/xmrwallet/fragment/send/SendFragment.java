...
package one.mayumi.xmrwallet.fragment.send;
...
import one.mayumi.xmrwallet.OnBackPressedListener;
import one.mayumi.xmrwallet.OnUriScannedListener;
import one.mayumi.xmrwallet.R;
import one.mayumi.xmrwallet.WalletActivity;
import one.mayumi.xmrwallet.data.BarcodeData;
import one.mayumi.xmrwallet.data.PendingTx;
import one.mayumi.xmrwallet.data.TxData;
import one.mayumi.xmrwallet.data.UserNotes;
import one.mayumi.xmrwallet.layout.SpendViewPager;
import one.mayumi.xmrwallet.model.PendingTransaction;
import one.mayumi.xmrwallet.util.Helper;
import one.mayumi.xmrwallet.util.Notice;
import one.mayumi.xmrwallet.util.ThemeHelper;
import one.mayumi.xmrwallet.widget.DotBar;
