...
import one.mayumi.xmrwallet.data.TxData;
import one.mayumi.xmrwallet.data.UserNotes;
import one.mayumi.xmrwallet.dialog.CreditsFragment;
import one.mayumi.xmrwallet.dialog.HelpFragment;
import one.mayumi.xmrwallet.fragment.send.SendAddressWizardFragment;
import one.mayumi.xmrwallet.fragment.send.SendFragment;
import one.mayumi.xmrwallet.ledger.LedgerProgressDialog;
import one.mayumi.xmrwallet.model.PendingTransaction;
import one.mayumi.xmrwallet.model.TransactionInfo;
