...
import one.mayumi.shruum.OnBackPressedListener;
import one.mayumi.shruum.OnUriScannedListener;
import one.mayumi.shruum.R;
import one.mayumi.shruum.WalletActivity;
import one.mayumi.shruum.data.BarcodeData;
import one.mayumi.shruum.data.PendingTx;
import one.mayumi.shruum.data.TxData;
import one.mayumi.shruum.data.UserNotes;
import one.mayumi.shruum.layout.SpendViewPager;
...
import one.mayumi.shruum.widget.DotBar;
